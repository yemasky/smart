...
<table border="0" cellspacing="0" cellpadding="1">
    ...
    <tr>
        ...
        <td><input type="text" name="module_view[<%$module_id%>]" value="<%$module.module_view%>" /></td>
...
<form action="manage.php?action=setModule&method=AddModule" name="Add_form" method="post" enctype="multipart/form-data">
<table border="0" cellspacing="0" cellpadding="1">
    <tr>
        <td>频道</td>
        <td>名称</td>
    ...
    <tr>
        ...
        <td><input type="text" name="module_view" value="" /></td>
