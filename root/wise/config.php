...
if(!defined('CONFIG_PHP')) {
	...
	//file
	define('__FILE_PATH', __WWW_PATH . 'data/file/');
	define('__FILE_WEB', __WEB . 'data/file/');
	//images
	...
	if(DIRECTORY_SEPARATOR == "/") { //linux
		...
		define('__WEIXIN_PIPE', '/var/www/hotel_web/root/api/');
	} else { //windows
		define('__PHP_CLI', 'C:/xampp/php/php.exe ');
		define('__WEIXIN_PIPE', 'E:/SVN/hotel/trunk/root/api/');
	}
	//debug
	define('__Debug', true);
