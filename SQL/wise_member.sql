...
MySQL - 10.1.37-MariaDB : Database - wise_member
*********************************************************************
*/
...
CREATE TABLE `member` (
  ...
  `member_sex` enum('0','1') NOT NULL DEFAULT '0' COMMENT '性别 0女 1男',
  ...
  `wx_avatar` varchar(256) NOT NULL DEFAULT '' COMMENT '微信头像',
...
insert  into `member`(`member_id`,`member_nickname`,`member_name`,`member_mobile`,`member_email`,`member_sex`,`id_type`,`id_number`,`wx_avatar`,`member_password`,`member_password_salt`,`add_datetime`) values (1,'me','me','18500353881','kef@yelove.cn','0','id_card','','','111','111','2018-08-26 10:20:00');
...
CREATE TABLE `member_level` (
  ...
  `market_id` int(11) NOT NULL COMMENT '会员级别',
  `add_datetime` datetime NOT NULL,
  PRIMARY KEY (`member_id`,`company_id`,`channel_father_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `member_level` */

insert  into `member_level`(`member_id`,`company_id`,`channel_father_id`,`channel_id`,`market_id`,`add_datetime`) values (1,1,1,1,19,'0000-00-00 00:00:00');
